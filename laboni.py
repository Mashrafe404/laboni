...
def banner():
    print("""\x1b[0;37m   ___                   \n  / _ \_______             ® \n / ___/ __/ -_) Multi Brute  ┌──────────────────────────────┐\n/_/  /_/__\__/(_) Force 3.0  │  Script By Mashrafe Chowdhury  │\n       /  ^ \/ / // /  ^ \   │   •• Github.com/Mashrafe404 ••   │\n      /_/_/_/_/\_,_/_/_/_/   └──────────────────────────────┘""")
		...
		if len(i)<3:
			...
			if len(i)==3 or len(i)==4 or len(i)==5:
				...
				if "id" in ct:
					...
					results.append("778890")
					results.append("203040")
					results.append("112200")
					results.append("304050")
					results.append("234567")
					results.append("345678")
